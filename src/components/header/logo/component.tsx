export const Logo = () => {
    return (
        <div>
            <svg className={'header-logo'} version="1.1" x="0px" y="0px" viewBox="0 0 400 50">
                <title>SpaceX Logo</title>
                <g className="letter letter_s">
                ...
                <g className="letter letter_swoosh">
